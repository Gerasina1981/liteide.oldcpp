...
{
    public:
	    void HandleMapping(const wxString & token, const wxString & peek);
    ...
    protected:
        ...
        void HandleClass(bool isClass = true, wxString template_args = _T("") );
    ...
    private:
        ...
        Token* TokenExists(const wxString& name, Token* parent = 0, short int kindMask = (short int)(0xFFFF) ); // if parent is 0, all tokens are searched
