...
public:
    ...
    wxString GetToken(bool bGetValue = false, bool bTempalte = false);
	...
	unsigned int GetTokenIndex() const
	{
		return m_TokenIndex;
	}
...
protected:
    void BaseInit();
    wxString DoGetToken(bool bGetValue = false, bool bTempalte = false);
    bool ReadFile();
    bool SkipWhiteSpace();
