...
#define DLGFONT_CONTROL_EX(id,he,wi,es,or1,we,it,un,st,ch,ou,cl,qu,pi,fa) \
		{ id, {he,wi,es,or1,we,it,un,st,ch,ou,cl,qu,pi,fa} },

#define DLGFONT_DIALOG(lfHeight,lfFaceName) \
		{ -2, {lfHeight,0,0,0,0,0,0,0,DEFAULT_CHARSET,0,0,0,0,lfFaceName} },

#define DLGFONT_DIALOG_EX(he,wi,es,or1,we,it,un,st,ch,ou,cl,qu,pi,fa) \
		{ -2, {he,wi,es,or1,we,it,un,st,ch,ou,cl,qu,pi,fa} },
