 ...
 *
 * $Revision: 4909 $
 * $Id: searchtree.cpp 4909 2008-02-27 13:15:26Z mortenmacfly $
 * $HeadURL: http://svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/codecompletion/parser/searchtree.cpp $
 */
#include "stdafx.h"
    ...
    for(i = m_Children.begin(); i!= m_Children.end(); i++)
    {
        if(cnt == m_Children.size() - 1)
		{
           // newprefix[newprefix.length() - 1] = _T(' ');
			newprefix.SetAt(newprefix.length() - 1,_T(' '));
		}
